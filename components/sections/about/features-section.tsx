    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {features.map((feature, index) => (
          <motion.div
            key={index}
            className={`flex items-start space-x-4 p-6 rounded-xl bg-gradient-to-br ${feature.bgGradient} hover:shadow-md transition-all duration-300 border border-gray-100`}
          ...
          >
            <motion.div 
              className={`bg-gradient-to-r ${feature.gradient} p-3 rounded-lg shadow-sm`}
            ...
            <div>
              <h3 className={`font-semibold text-lg bg-gradient-to-r ${feature.gradient} bg-clip-text text-transparent`}>
                {feature.title}
              </h3>
